...
from app.services.agent.tools.check_command_status import get_check_command_status_tool
...
from app.services.agent.tools.stop_command import get_stop_command_tool
