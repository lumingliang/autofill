...
class TodoWriteInput(BaseModel):
    merge: bool = Field(description=(
        "Whether to merge the todos with the existing todos. If true, the todos will be\n"
...
def get_todo_write_tool() -> BaseTool:
    return StructuredTool.from_function(
        name="TodoWrite",
        description=(
            "Use this tool to create and manage a structured task list for your current coding session. This helps track progress, organize complex tasks, and demonstrate thoroughness to the user.\n"
