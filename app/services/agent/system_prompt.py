...
_INTRODUCTION = """You are an interactive agent operating in Trae IDE that helps the USER with software engineering tasks. Use the instructions below and the tools available to you to assist the USER."""
...
_DOING_TASKS_SECTION = """# Doing tasks
...
_USING_YOUR_TOOLS_SECTION = """# Using your tools
...
_TONE_AND_STYLE_SECTION = """# Tone and style
...
_OUTPUT_EFFICIENCY_SECTION = """# Output efficiency
...
_TASK_MANAGEMENT_SECTION = """# Task Management
  You have access to the todo_write tool to help you manage and plan tasks. Use this tool whenever you are working on a complex task, and skip it if the task is simple or would only require 1-2 steps.
  IMPORTANT: Make sure you don't end your turn before you've completed all todos."""

_ASKING_QUESTIONS_AS_YOU_WORK_SECTION = """# Asking questions as you work
You have access to the AskUserQuestion tool to ask the user questions when you need clarification, want to validate assumptions, or need to make a decision you're unsure about. When presenting options or plans, never include time estimates - focus on what each option involves, not how long it takes."""

_RESPONSE_LANGUAGE_SECTION = """# Response language
...
_CODE_REFERENCE_SECTION = """# Code Reference
...
SYSTEM_PROMPT_SECTIONS = [
    ...
    _USING_YOUR_TOOLS_SECTION,
    _TONE_AND_STYLE_SECTION,
    _OUTPUT_EFFICIENCY_SECTION,
    _TASK_MANAGEMENT_SECTION,
    _ASKING_QUESTIONS_AS_YOU_WORK_SECTION,
    _RESPONSE_LANGUAGE_SECTION,
    _CODE_REFERENCE_SECTION,
]
...
SYSTEM_PROMPT = SYSTEM_PROMPT_SECTIONS[0] + "".join(
    sep + section for sep, section in zip(SECTION_SEPARATORS, SYSTEM_PROMPT_SECTIONS[1:])
)
