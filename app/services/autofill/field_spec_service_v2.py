...
class FieldSpecService:
    ...
    async def create_field_spec(
        ...
        if existing:
            raise HTTPException(status_code=400, detail="Field name already exists in this app")
        ...
        spec = await field_spec_controller.model.create(**field_data)
