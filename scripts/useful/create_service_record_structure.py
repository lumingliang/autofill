...
DEFAULT_TEMPLATES_CSV = "/Users/lu/code/code/py/autofill/test_csv_data/templates_export.csv"
DEFAULT_FIELDS_CSV = "/Users/lu/code/code/py/autofill/test_csv_data/template_fields.csv"
PAGE_NAME = "用户信息页"
