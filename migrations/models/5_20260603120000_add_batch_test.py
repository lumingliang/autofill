...
async def upgrade(db: BaseDBAsyncClient) -> str:
    ...
    KEY `idx_batch_test__created_60ea34` (`created_at`),
    KEY `idx_batch_test__updated_cefa69` (`updated_at`),
    KEY `idx_batch_test__tenant__4368da` (`tenant_id`),
    KEY `idx_batch_test__task_na_29b82e` (`task_name`),
    KEY `idx_batch_test__dify_ag_8c8fa0` (`dify_agent_id`)
